...
const weaponStats = {
	...
	scavenger : {
		...
		templates: [
			{ res: "R-NRS-BusCannon", body: "B1BaBaPerson01", prop: "BaBaLegs", weapons: [ "BusCannon", ] },
			{ res: "R-NRS-BusCannon", body: "B1BaBaPerson01", prop: "BaBaLegs", weapons: [ "bTrikeMG", ] },
			{ res: "R-NRS-BabaRocket", body: "B1BaBaPerson01", prop: "BaBaLegs", weapons: [ "BabaRocket", ] },
			{ res: "R-NRS-BabaFlame", body: "B1BaBaPerson01", prop: "BaBaLegs", weapons: [ "BabaFlame", ] },
			{ res: "R-NRS-BabaPitRocket", body: "B1BaBaPerson01", prop: "BaBaLegs", weapons: [ "BabaPitRocket", ] },
			{ res: "R-NRS-BabaPitRocketAT", body: "B1BaBaPerson01", prop: "BaBaLegs", weapons: [ "BabaPitRocketAT", ] },
			{ res: "R-NRS-ScavNEXUSlink", body: "B1BaBaPerson01", prop: "BaBaLegs", weapons: [ "ScavNEXUSlink", ] },
			{ res: "R-NRS-BuggyMG", body: "B1BaBaPerson01", prop: "BaBaLegs", weapons: [ "BuggyMG", ] },
			{ res: "R-NRS-BJeepMG", body: "B1BaBaPerson01", prop: "BaBaLegs", weapons: [ "BJeepMG", ] },
		],
		extras: [
			"R-ROCKET-Damage-9",
