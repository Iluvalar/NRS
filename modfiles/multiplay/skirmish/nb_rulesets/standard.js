...
const weaponStats = {
	extralasers : {
		...
		chatalias : 1,
		weapons : [
			{ res: "R-NRS-Laser-AP1-contingency", stat: "Laser-AP1-contingency", weight: WEIGHT.MEDIUM },
			{ res: "R-NRS-Laser-AP2-contingency", stat: "Laser-AP2-contingency", weight: WEIGHT.MEDIUM },
			{ res: "R-NRS-Laser-AP3-contingency", stat: "Laser-AP3-contingency", weight: WEIGHT.MEDIUM },
			{ res: "R-NRS-Laser-AP4-contingency", stat: "Laser-AP4-contingency", weight: WEIGHT.MEDIUM },
			{ res: "R-NRS-Laser-AA2-contingency", stat: "Laser-AA2-contingency", weight: WEIGHT.MEDIUM },
			{ res: "R-NRS-Laser-Sonic-contingency", stat: "Laser-Sonic-contingency", weight: WEIGHT.MEDIUM },
		],
		vtols : [
		],
		defenses : [
		...
		extras: [
			"R-SLOW MISSILE-Damage--contingency-18",
			"R-SLOW MISSILE-FirePause--contingency-18",
		],
	},
	ATlasers : {
		...
		chatalias : 2,
		weapons : [
			{ res: "R-NRS-Laser-AT1-contingency", stat: "Laser-AT1-contingency", weight: WEIGHT.MEDIUM },
			{ res: "R-NRS-Laser-AT2-contingency", stat: "Laser-AT2-contingency", weight: WEIGHT.MEDIUM },
			{ res: "R-NRS-Laser-AT3-contingency", stat: "Laser-AT3-contingency", weight: WEIGHT.MEDIUM },
			{ res: "R-NRS-Laser-AT4-contingency", stat: "Laser-AT4-contingency", weight: WEIGHT.MEDIUM },
			{ res: "R-NRS-Laser-TankDest2Lgt-contingency", stat: "Laser-TankDest2Lgt-contingency", weight: WEIGHT.MEDIUM },
			{ res: "R-NRS-Laser-TankDestLgt-contingency", stat: "Laser-TankDestLgt-contingency", weight: WEIGHT.MEDIUM },
		],
		vtols : [
		],
		defenses : [
		...
		extras: [
			"R-HOWITZERS-Damage--contingency-18",
			"R-HOWITZERS-FirePause--contingency-18",
		],
	},
	contmortars : {
		...
		weapons : [
			...
			{ res: "R-NRS-Mortar-GaussHvy-contingency", stat: "Mortar-GaussHvy-contingency", weight: WEIGHT.MEDIUM },
			{ res: "R-NRS-Mortar-GaussRamjet-contingency", stat: "Mortar-GaussRamjet-contingency", weight: WEIGHT.MEDIUM },
			{ res: "R-NRS-Mortar-GaussHvyPlas-contingency", stat: "Mortar-GaussHvyPlas-contingency", weight: WEIGHT.MEDIUM },
			{ res: "R-NRS-Mortar-GaussRot-contingency", stat: "Mortar-GaussRot-contingency", weight: WEIGHT.MEDIUM },
			{ res: "R-NRS-Mortar-Ramjet-contingency", stat: "Mortar-Ramjet-contingency", weight: WEIGHT.MEDIUM },
			{ res: "R-NRS-Mortar-GaussRotPlas-contingency", stat: "Mortar-GaussRotPlas-contingency", weight: WEIGHT.MEDIUM },
			{ res: "R-NRS-Mortar-GaussRamjetHvy-contingency", stat: "Mortar-GaussRamjetHvy-contingency", weight: WEIGHT.MEDIUM },
			{ res: "R-NRS-Mortar-RamjetRot-contingency", stat: "Mortar-RamjetRot-contingency", weight: WEIGHT.MEDIUM },
			{ res: "R-NRS-Mortar-RamjetHvy-contingency", stat: "Mortar-RamjetHvy-contingency", weight: WEIGHT.MEDIUM },
		],
		vtols : [
		],
		defenses : [
		...
		extras: [
			"R-ENERGY-Damage--contingency-18",
			"R-ENERGY-FirePause--contingency-18",
		],
	},
	contcannons : {
		...
		weapons : [
			...
			{ res: "R-NRS-Cannon-HPVGattling-contingency", stat: "Cannon-HPVGattling-contingency", weight: WEIGHT.MEDIUM },
			{ res: "R-NRS-Cannon-HPVHvy-contingency", stat: "Cannon-HPVHvy-contingency", weight: WEIGHT.MEDIUM },
			{ res: "R-NRS-Cannon-HPVLgt-contingency", stat: "Cannon-HPVLgt-contingency", weight: WEIGHT.MEDIUM },
			{ res: "R-NRS-Cannon-HPVTankDestLgt-contingency", stat: "Cannon-HPVTankDestLgt-contingency", weight: WEIGHT.MEDIUM },
			{ res: "R-NRS-Cannon-HPVTwinAslt-contingency", stat: "Cannon-HPVTwinAslt-contingency", weight: WEIGHT.MEDIUM },
			{ res: "R-NRS-Cannon-Sniper-Bunker-contingency", stat: "Cannon-Sniper-Bunker-contingency", weight: WEIGHT.MEDIUM },
		],
		vtols : [
		],
		defenses : [
		...
		extras: [
			"R-MORTARS-Damage--contingency-18",
			"R-MORTARS-FirePause--contingency-18",
		],
	},
	heavylaser : {
		roles : [ 0.1, 0.5, 0.2, 0.2 ],
		...
		extras: [
			"R-SLOW ROCKET-Damage--18",
			"R-SLOW ROCKET-FirePause--18",
		],
	},
	rail : {
		roles : [ 0.4, 0.3, 0.1, 0.2 ],
	...
	mortar : {
		...
		templates: [
			...
			{ res: "R-NRS-Mortar2Mk1-2120", body: "CyborgHeavyBody", prop: "CyborgLegs", weapons: [ "Cyb-Wpn-Grenade-2120", ] },
		],
		extras: [
			"R-ENERGY-Damage--18",
			"R-ENERGY-FirePause--18",
		],
	},
	scavenger : {
	...
	rocket : {
		...
		extras: [
			"R-HOWITZERS-Damage--18",
			"R-HOWITZERS-FirePause--18",
		],
	},
	quark : {
		roles : [ 0.4, 0.3, 0.1, 0.2 ],
		...
		extras: [
			"R-MORTARS-Damage--2120-18",
			"R-MORTARS-FirePause--2120-18",
		],
	},
	ASrocket : {
		roles : [ 0.1, 0.2, 0.5, 0.2 ],
	...
	heavyrocket : {
		...
		extras: [
			"R-MACHINE GUN-Damage--2120-18",
			"R-MACHINE GUN-FirePause--2120-18",
		],
	},
	indirectmissile : {
		roles : [ 0.1, 0.2, 0.5, 0.2 ],
	...
	mediumlaser : {
		...
		extras: [
			"R-SLOW MISSILE-Damage--2120-18",
			"R-SLOW MISSILE-FirePause--2120-18",
		],
	},
};
